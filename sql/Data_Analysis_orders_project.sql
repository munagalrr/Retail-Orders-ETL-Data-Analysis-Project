...
with cte as(
select sub_category, year(order_date) as order_year, sum(profit_per_item) as profit
from df_orders
group by sub_category, year(order_date)
--order by sub_category, year(order_date) desc, profit desc
)
, cte2 as (
select sub_category
...
select *
, (profit_2023-profit_2022)*100/profit_2022 as Profit_Growth
from cte2
